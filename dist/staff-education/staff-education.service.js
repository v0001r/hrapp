...
exports.StaffEducationService = void 0;
const common_1 = require("@nestjs/common");
const event_emitter_1 = require("@nestjs/event-emitter");
const mongoose_1 = require("mongoose");
const staff_education_repository_1 = require("./staff-education.repository");
let StaffEducationService = class StaffEducationService {
    constructor(staffEducationModel, staffEducationRepository, eventEmitter) {
        this.staffEducationModel = staffEducationModel;
        this.staffEducationRepository = staffEducationRepository;
...
exports.StaffEducationService = StaffEducationService;
exports.StaffEducationService = StaffEducationService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)('StaffEducation')),
    __metadata("design:paramtypes", [mongoose_1.Model,
        staff_education_repository_1.StaffEducationRepository,
        event_emitter_1.EventEmitter2])
], StaffEducationService);
//# sourceMappingURL=staff-education.service.js.map